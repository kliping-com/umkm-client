...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('legal.acceptableUse');
  const ti = await getTranslations('legal.index.items.acceptableUse');
  return {
    title: t('title'),
...
export default function Page() {
  const t = useTranslations('legal.acceptableUse');
