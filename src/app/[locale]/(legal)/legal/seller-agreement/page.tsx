...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('legal.sellerAgreement');
  const ti = await getTranslations('legal.index.items.sellerAgreement');
  return {
    title: t('title'),
...
export default function Page() {
  const t = useTranslations('legal.sellerAgreement');
